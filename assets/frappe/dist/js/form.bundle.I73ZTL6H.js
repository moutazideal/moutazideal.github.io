(() => {
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/address_list.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/contact_list.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_dashboard.html
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_footer.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_links.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_sidebar.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/print_layout.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/report_links.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/set_sharing.html
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/timeline_message_box.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/users_in_sidebar.html
...
`;
      ...
      let rename_document = () => {
        ...
        return frappe.xcall("frappe.model.rename_doc.update_document_title", {
          ...
          const reload_form = (input_name2) => {
            frappe.model.rename_doc_in_locals(doctype, docname, input_name2, merge);
  ...
  frappe.ui.get_print_settings = function(pdf, callback, letter_head, pick_columns, is_query_report = false, title = null, default_print_format = null) {
    ...
    if (is_query_report) {
      columns.splice(1, 0, {
        ...
        onchange: function() {
          ...
          (_a = dialog.fields_dict.columns) == null ? void 0 : _a.select_all(true);
        }
      });
    }
    if (is_query_report) {
...
${this.frm.doctype_layout.client_script}`;
  ...
  frappe.ui.form.Attachments = class Attachments {
    ...
    new_attachment(fieldname) {
      ...
      new frappe.ui.FileUploader({
        ...
        make_attachments_public: fieldname && ((_a = this.frm.get_docfield(fieldname)) == null ? void 0 : _a.make_attachment_public) ? 1 : this.frm.meta.make_attachments_public,
        on_success: (file_doc) => {
  ...
  frappe.ui.form.Form = class FrappeForm {
    ...
    switch_doc(docname) {
      ...
      (_a = this.layout) == null ? void 0 : _a.sections.forEach((section) => section.expanded_by_user = false);
      frappe.ui.form.close_grid_form();
...
//# sourceMappingURL=form.bundle.I73ZTL6H.js.map
