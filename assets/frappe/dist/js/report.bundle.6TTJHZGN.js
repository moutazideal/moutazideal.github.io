(() => {
      ...
      return {
        ...
        setValue: (value2) => {
          ...
          return this.set_control_value(doctype, docname, fieldname, value2).then((updated_doc) => {
            ...
            const cell_at_index = (_a = this.datatable.datamanager.rows[rowIndex]) == null ? void 0 : _a[colIndex];
            if ((cell_at_index == null ? void 0 : cell_at_index.name) !== docname) {
              this.datatable.refresh(this.get_data(this.data), this.columns);
            }
          ...
          if (Array.isArray(row)) {
            doc = row.reduce((acc, curr) => {
              if (!curr.column.docfield)
                return acc;
              if (curr.content && curr.column.docfield.fieldtype == "Link" && frappe.boot.link_title_doctypes.includes(curr.column.docfield.options)) {
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/home/fic/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
//# sourceMappingURL=report.bundle.6TTJHZGN.js.map
